...
Supabase, real-time data sync, structured data pipelines

### Cloud & Infrastructure  
AWS, GCP, Cloudflare  
Serverless, edge compute, networking, colocation hardware, system deployment

### Payments & Commerce  
Stripe, Braintree, PayPal SDK integrations  
Subscription systems, billing workflows, transaction reliability

### AI & Automation  
AI workflow integration, agentic systems  
Model utilisation (OpenAI, Claude), visual models, semantic search, automation pipelines

### Testing & Reliability  
End-to-end testing, system validation  
Jest, Vitest, CI/CD integration
...
VSCode, Linear, Figma, Photoshop  
Modern AI-assisted development (Codex, Claude, OpenAI)  
Strong focus on developer experience, automation, and iteration speed
